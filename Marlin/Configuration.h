...
#define STRING_CONFIG_H_AUTHOR "(Kokorone, ELF BL-Touch Scaled)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // ELF stock
  #define DEFAULT_bedKp 64.07
  #define DEFAULT_bedKi 11.58
  #define DEFAULT_bedKd 236.29
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 120, 120, 4, 70 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 20, 20, 40 }
